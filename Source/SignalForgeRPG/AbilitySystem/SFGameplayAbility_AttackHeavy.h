...
#include "SFGameplayAbility_AttackHeavy.generated.h"
...
UCLASS()
class SIGNALFORGERPG_API USFGameplayAbility_AttackHeavy : public USFGameplayAbility
{
	GENERATED_BODY()

public:
	USFGameplayAbility_AttackHeavy();
